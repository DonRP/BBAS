...
translate crowdin strings:
    ...
    new "Come risultato della ricerca di informazioni su Internet su ciò che Alice poteva fare, è stato possibile scoprire qualcosa. I più popolari erano i blog, dove i presentatori sono ragazze. Inoltre, più rivelano gli abiti e più grandi sono i seni, più popolare è lo spettacolo. Con il seno, ovviamente, non si può fare nulla, ma gli abiti ... Forse parlarle?
    ...
    new "Ho dato ad Alice un bel set di biancheria intima. Le piaceva. È vero, non riuscivo a vedere nulla, solo Alice è già in questa biancheria intima, ma anche questo è stato eccitante ... Curiosamente, ha accennato che puoi cercare qualcosa di più ... sexy!
    ...
    new "E se non aiutasse Lisa per un po'? O farò un errore nel suo lavoro più volte
