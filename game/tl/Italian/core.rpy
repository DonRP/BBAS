...
translate crowdin cam_after_waiting_6058d5d4:
    ...
    Max_09 "Penso che guardare le telecamere ora non sia l'idea migliore. Non c'era abbastanza per Lisa per notare qualcosa... Forse dovresti andare in veranda? Nessuno dovrebbe essere lì adesso..." nointeract
...
translate crowdin cam_after_waiting_c283f316:
    ...
    Max_09 "Lisa è nella stanza in questo momento... E sulla veranda il posto è occupato! È meglio non correre rischi e aspettare con le telecamere.
...
translate crowdin cam_after_waiting_38f46f18:
    ...
    Max_09 "Meglio vedere le telecamere altrove! Non bastava che Lisa notasse qualcosa... "nointeract
...
translate crowdin cam_after_waiting_d4f49617:
    ...
    Max_09 "Forse non dovresti guardare le telecamere ora. Lisa potrebbe svegliarsi e notare quello che sto facendo... Forse dovresti andare in veranda? Nessuno dovrebbe essere lì adesso..." nointeract
...
translate crowdin cam_after_waiting_27f05bf1:
    ...
    Max_00 "Non sta succedendo niente qui in questo momento."
...
translate crowdin after_buying_5c93d1fb:
    ...
    Max_01 "{i}( Quindi, ho ordinato la fotocamera, rimane da aspettare la consegna ... ){/i}"
...
translate crowdin after_buying_7c1c8dcc:
    ...
    Max_07 "{i}( Mi chiedo in cosa verrà fotografata zia Kira dai vestiti? Ne ha bisogno per un portafoglio... Quindi forse dovrei comprare qualcosa di sexy per lei? Ad esempio, una tenda da notte più franca! Questo andrà solo a me... ){/i}"
