...
translate crowdin strings:
    ...
    new "{color=#E59400}{i}Sei passato inosservato!{/i}{/color}\n"
    ...
    new "{color=#E59400}{i}La mamma ha apprezzato il massaggio!{/i}{/color}\n"

    # game/core/02init.rpy:32
    old "{color=#E59400}{i}Маме не понравился массаж!{/i}{/color}\n"
    new "{color=#E59400}{i}La mamma non ha apprezzato il massaggio!{/i}{/color}\n"
    ...
    new "Questo gioco è controllabile con la tastiera. Puoi salvare in qualsiasi momento. Le scorciatoie da tastiera predefinite sono:\nF5 - salva, F8 - carica. \n\n\nSolo durante i dialoghi i tasti 1... 9 funzionano per le diverse scelte di risposta durante i dialoghi. Se c'è solo un'opzione, potete premere il tasto [[Space]. \n\n\nPer passare da una stanza all'altra, potete usare i tasti 1... 7.\n\n\nPer disattivare l'interfaccia, si può premere il tasto [[ ` ], [[ h ] o il tasto centrale del mouse.\nÈ molto utile se l'area della finestra di dialogo nasconde una parte interessante dell'immagine..."
    ...
    new "Nel corso del gioco, durante i dialoghi e altre azioni, è possibile scoprire nuove \"opportunità\". La loro meccanica è un po' simile alle \"quest\" e alle \"missioni\" in altri giochi, ma con alcune differenze. \n\n\n\"Le opportunità\" possono sbloccare eventi nascosti o articoli nel negozio online, nuove opzioni nel portatile o azioni in certe stanze. Leggete attentamente la descrizione di ogni \"funzionalità\" e non vi mancherà nulla!"
    ...
    new "Varie azioni o frasi dette da Max possono provocare una reazione corrispondente sotto forma di un cambiamento dell'umore del personaggio.\n\n\nSe un personaggio è di cattivo umore, può rifiutarsi di parlare di certi argomenti con te.\n\n\nGradualmente, ogni ora, l'umore ritorna a uno stato neutro. Tuttavia, se l'umore è davvero cattivo, ci vorrà molto tempo per recuperare.\n\n\nPer sollevare l'umore, puoi dare ciò di cui hai bisogno a quel personaggio o semplicemente scusarti. E a volte anche la parola giusta durante una conversazione può migliorare l'umore."
    ...
    new "Ho ordinato la spesa!"

    # game/core/02init.rpy:128
    old "Мам, бассейн чист!"
    new "Mamma, ho pulito la piscina!"
    ...
    new "Sì, qui c'è sempre bel tempo"
    ...
    new "Allora, quando facciamo un altro servizio fotografico?"
