...
msgstr "{color=#00FF00}{i}Fortuna!{/i}{/color}\n"
...
msgstr "{color=#E59400}{i}Persuasione fallita!{/i}{/color}\n"

#    # game/core/02init.rpy:30
msgid "{color=#E59400}{i}Вас заметили!{/i}{/color}\n"
msgstr "{color=#E59400}{i}Sei stato notato!{/i}{/color}\n"
...
msgstr "{color=#E59400}{i}Sfortuna!{/i}{/color}\n"
...
msgstr "Scusa, ma ti ho visto per caso mentre facevi la doccia..."

#    # game/core/02init.rpy:130
msgid "Хочу извиниться. Я бессовестно подглядывал за тобой утром..."
msgstr "Voglio scusarmi. Stamattina ti stavo vergognosamente spiando..."
...
msgstr "Hai bisogno di aiuto per apparecchiare la tavola?"

#    # game/core/02init.rpy:130
msgid "Я пришёл извиниться за то, что было утром. Я больше не буду."
msgstr "Sono venuto a scusarmi per quello che è successo stamattina. Non lo farò più."

#    # game/core/02init.rpy:130
msgid "Я снова подглядывал. Извини."
msgstr "Ti stavo spiando di nuovo. Mi dispiace."

#    # game/core/02init.rpy:130
msgid "Ну давай, можешь меня наказывать..."
msgstr "Avanti, puoi punirmi..."

#    # game/core/02init.rpy:130
msgid "Я выбираю наказание от тебя..."
msgstr "Scelgo di essere punito da te..."
...
msgstr "Ecco dei soldi per tenerti lontano da Lisa..."

#    # game/core/02init.rpy:130
msgid "У меня нет денег, чтобы ты не лез к Лизе."
msgstr "Non ho i soldi per tenerti lontano da Lisa."
...
msgstr "Quando ci sarà un nuovo servizio fotografico, zia Kira?"
...
msgstr "Ho un regalo per te {i}(Completo in pelle){/i}"

#    # game/core/02init.rpy:248
msgid "У меня для тебя подарок {i}(Плётка){/i}"
msgstr "Ho un regalo per te {i}(La frusta){/i}"
