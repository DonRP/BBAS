...
translate english intro_8dea4dcf:
    ...
    Max_00 "Hi, I'm Max. Я обычный парень из обычной семьи. Ну как обычной... нормальной. Хотя, кого я обманываю. Нормального в моей семье мало. Но обо всём по порядку." nointeract
...
translate english intro_0f762891:
    ...
    Max_01 "I got kicked out of school. Официально - за низкую успеваемость. Хотя оценки были так себе, но настоящая причина в математичке. Говорят, я приставал... Да она сама глазки строила! Директору, её мужу, это почему-то не понравилось..."
...
translate english intro_20141f46:
    ...
    Max_00 "My family adopted me when I was just 3 years old. Мои же настоящие родители таинственно исчезли и их так и не нашли. Надеюсь, что когда-нибудь об этом хоть что-то станет известно..."
...
translate english intro_95eb5e47:
    ...
    Max_01 "When I was about to turn 19, I was expelled from school. Официально - за низкую успеваемость. Хотя оценки были так себе, но настоящая причина в математичке. Говорят, я приставал... Да она сама глазки строила! Директору, её мужу, это почему-то не понравилось..."
...
translate english intro_1c9ab78c:
    ...
    Max_04 "This is my Mom, Ann. Сама воспитывает нас с двумя сёстрами уже несколько лет. Работает в офисе какой-то компании. Хотя, зарплата у неё вполне приличная, но почти всё уходит на оплату съёмного жилья, еду и одежду."
...
translate english intro_e288a47f:
    ...
    Max_04 "This is Ann, my adoptive Mom. У неё есть две родные дочери и она воспитывает нас троих уже много лет одна. Работает в офисе какой-то компании. Хотя, зарплата у неё вполне приличная, но почти всё уходит на оплату съёмного жилья, еду и одежду."
...
translate english intro_cb16881c:
    ...
    Max_00 "This is our apartment. Тот ещё тараканник! Мама пытается заработать на первый взнос, чтобы взять ипотеку, но пока что-то не получается. Все мы мечтаем отсюда съехать, но куда?"
...
translate english intro_4547bbbc:
    ...
    Max_08 "Alice, my older sister. Недавно закончила школу и, так же, как и я, ищет свой путь. Целыми днями сидит в ноутбуке и занимается каким-то своим блогом. Как это часто бывает с братьями и старшими сёстрами, мы не очень ладим..."
...
translate english intro_ff38ed12:
    ...
    Max_08 "This is Alice, my older sister. Хоть она мне и не родная, но тем не менее, мы росли под одной крышей с самых малых лет, так что косички я ей подёргал за это время на славу. Уже несколько лет, как закончила школу, но до сих пор ищет свой путь, так же, как и я теперь. Целыми днями сидит в ноутбуке и занимается каким-то своим блогом. Как это часто бывает с братьями и старшими сёстрами, мы не очень ладим..."
...
translate english intro_75876970:
    ...
    Max_00 "Lisa, my littler sister. Не знаю как учится, но если не выгнали как меня, значит всё в порядке. С Лизой мы общаемся на одной волне, хотя изредка ссоримся. Но если что-то случается, защиты ищет именно у меня."
...
translate english intro_6274a5c1:
    ...
    Max_00 "This is Lisa, my younger sister. Не знаю как учится, но, если не выгнали как меня, значит всё в порядке. С Лизой мы практически ровесники, ей уже восемнадцать лет. Мы общаемся на одной волне, хотя изредка ссоримся. Но если что-то случается, защиты ищет именно у меня."
...
translate english intro_bebe466e:
    ...
    Max_14 "I don't remember my father. Он ушёл, когда мне было лет пять. Мама не хочет рассказывать, что тогда случилось... Ходили слухи, что дела у него пошли в гору. С тех пор мы о нём ничего не слышали. До прошлого месяца, когда пришла та девушка..."
...
translate english intro_c94c5394:
    ...
    Max_14 "I can’t remember my adoptive father very well. Он ушёл, когда мне было лет восемь. Мама не хочет рассказывать, что тогда случилось... Ходили слухи, что дела у него пошли в гору. С тех пор мы о нём ничего не слышали. До прошлого месяца, когда пришла та девушка..."
...
translate english intro_fdc8ae44:
    ...
    Maya_01 "Hello, my name is Maya, I'm your ex-husbands lawyer. У вас найдётся для меня минутка?"
...
translate english intro_165806c1:
    ...
    Ann_00 "Yes, of course. Меня зовут Анна, но вы и так это знаете похоже. Так в чём дело? С ним что-то случилось?"
...
translate english intro_9858c279:
    ...
    Ann_01 "Is that right? И что же это за новости спустя столько лет?"
...
translate english intro_a97592f1:
    ...
    Maya_02 "I've brought with me some documents that if you sign, will transfer the ownership of one of his residential properties to you. Если вы их подпишите, то станете полноправным владельцем."

# game/script.rpy:74
translate english intro_8b0c7301:

    # Ann_17 "Что-то я не поняла. Это совсем на него не похоже. Какая недвижимость? О чём речь?"
    Ann_17 "I'm not sure that I understand you correctly. Это совсем на него не похоже. Какая недвижимость? О чём речь?"
...
translate english intro_ce5a5dae:
    ...
    Maya_01 "It's a two story house built by his company. А насчёт того, что это на него не похоже... В последние пару лет он очень изменился. Не уверена, что эти изменения пошли на пользу бизнесу."
...
translate english intro_60f50736:
    ...
    Maya_02 "At the moment, he's sold most of his property to pay off debt, but decided to pass this house on to you. Я не знаю причин, да они меня и не касаются."
...
translate english intro_ea2ebd5a:
    ...
    Ann_00 "I can't just accept this... подарок. Во-первых, я не в курсе его махинаций или что он там придумал, а во-вторых, мы с ним уже столько лет не общались, и мне не нужно от него ничего!"
...
translate english intro_734c8765:
    ...
    Maya_01 "Yes, he told me you might say that... С юридической точки зрения дом абсолютно чист, и вы ничем не рискуете. Кроме того, ваши дети растут и им нужно место, своё личное пространство..."
...
translate english intro_8e21e5ab:
    ...
    Maya_03 "Of course, Ann. Вот моя визитка. Позвоните, когда будете готовы принять решение. Также я оставлю копии всех документов. До свидания." nointeract
...
translate english intro_eaf717b9:
    ...
    Max_04 "Fortunately, Mom made the right decision. Когда мы увидели дом, не поверили своим глазам! Вживую он оказался гораздо больше и красивее, чем на фотографиях. Но самым приятным сюрпризом оказался бассейн!"
...
translate english intro_afbd2795:
    ...
    Max_00 "Alice immediately took one of the bedrooms for herself, saying she needed the space for her blog. Кстати, их оказалось всего две. Несмотря на огромную гостиную с кухней и просторную ванную, в доме всего три отдельные комнаты: две спальни и кабинет."
...
translate english intro_c174fdf7:
    ...
    Ann_01 "For some reason, I don't like this idea of yours, Max. Вы уже взрослые, чтобы спать в одной комнате. Давай этот офис выделим тебе, а вторую спальню - Лизе. Ну а я буду спать в гостиной. Там отличные диванчики..."
...
translate english intro_d6949af8:
    ...
    Ann_01 "I'm not sure about that idea, Max. Вы уже совсем взрослые, чтобы спать в одной комнате. Давай этот офис выделим тебе, а вторую спальню - Лизе. Ну а я буду спать в гостиной. Там отличные диванчики..."
...
translate english intro_fbedb073:
    ...
    Lisa_02 "Of course! Мам, мы нормально с Максом уживаемся. А если будет косячить, выгоню его в эту самую гостиную! А ты свою комнату точно заслужила. И не спорь. Мы все так думаем."
...
translate english intro_dbd412b7:
    ...
    Max_00 "A week later we got some stuff from our old apartment, but far from everything. Но только часть. Как я понял, кое-что потерялось в пути. Надеюсь, компенсируют это как-то..."
...
translate english about_poss_0cd5a085:
    ...
    Max_00 "\"Opportunities\" - are special circumstances that can lead to rewards. Обычно они скрыты и не очень очевидны."
...
translate english about_poss_0f75481c:
    ...
    Max_03 "Some of the actions in the game open \"opportunities\". Увидеть их можно на соответствующем экране, который можно открыть через верхнее меню."
...
translate english about_poss_09cf07b7:
    ...
    Max_00 "Some of the \"opportunities\" have a time limit. Некоторые могут привести к нежелательному результату. Не стоит хвататься за первую попавшуюся и слепо следовать подсказкам!"
...
translate english about_poss_95f72849:
    ...
    Max_04 "But you shouldn't be afraid of them either. Именно благодаря \"возможностям\" можно добиться того, о чём некоторые даже не мечтают!" nointeract
