...
translate crowdin typical_dinner_abe1c298:
    ...
    # Ann_01 "Всем приятного аппетита. Ich bin froh, Max, dass du die Lebensmittel auf eigene Kosten gekauft hast. И бассейн я вижу чистый. Молодец, что взял на себя эту ответственность, мы все это ценим. А теперь давайте ужинать..." nointeract
