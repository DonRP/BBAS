...
translate crowdin strings:
    ...
    new "{i}masajea tu espalda{/i}"

    # game/core/imagemaps.rpy:87
    old "{i}массировать попку{/i}"
    new "{i}masajear mi culo{/i}"

    # game/core/imagemaps.rpy:108
