...
#--- ""
    ...
    new "Hablé con Lisa sobre su entrenamiento. Ella presentó una serie de condiciones, incluida la prohibición de que yo la tocara si estaba en contra. Bueno, es algo."
#--- ""

    # game/core/oldfix.rpy:461
    old "Похоже обучаться Лиза согласна только если у неё хорошее настроение..."
    new "Parece que Lisa acepta estudiar solo si está de buen humor..."
#--- ""
...
#--- ""
    ...
    new "Le di a Alice un lindo conjunto de ropa interior. Le encantó. ¡Incluso se lo probó conmigo! Es cierto que no vi casi nada, pero fue emocionante ... Lo más curioso es que insinuó que puedes buscar algo más ... ¡Sexual!"
#--- ""
    ...
    new "Le di a Alice un lindo conjunto de ropa interior. Le encantó. Es cierto que no pude ver nada, solo Alice ya está en ropa interior, pero incluso esto fue emocionante ... Lo más curioso es que insinuó que puedes buscar algo más ... ¡Sexual!"
#--- ""
    ...
    new "Le di a Alice un lindo conjunto de ropa interior. Le encantó. ¡Incluso se lo probó conmigo! No vi tanto, pero fue emocionante ... Lo más curioso es que insinuó que puedes buscar algo más ... ¡Sexual!"
#--- ""
    ...
    new "Le conté a mi Tía todo sobre Eric, así es como es, así le dije. Ella parece dudar de mis palabras, pero prometió averiguar todo cuidadosamente. Tal vez incluso el propio Eric hable..."
#--- ""
    ...
    new "Kira me ofreció algo de dinero. Solo necesito tomarle una foto. Eso es solo para estos fines que necesitas una cámara. Por supuesto, es poco probable que me pague tanto como cuesta la cámara, pero existe la posibilidad de que algo más se rompa para esta sesión de fotos..."
#--- ""
    ...
    new "Entonces, las fotos salieron exitosas y Kira y yo acordamos una nueva sesión de fotos hasta que nadie estuviera en casa. Pero aún no está claro cuándo lo celebraremos... Me pregunto qué quiere conseguir Kira para filmar. Solo puedo esperar..."
#--- ""

    # game/core/oldfix.rpy:565
    old "А ещё, будет не лишним, купить для этой фотосессии сексуальную сорочку для моей любимой тёти!"
    new "Y, sin embargo, ¡no será superfluo comprar para esta sesión de fotos una camisa sexy para mi querida tía!"
#--- ""
    ...
    new "¿Qué fue eso? Mamá me sorprendió espiándolos mientras estaban follando, me iba a castigar, pero Eric dijo que no y mamá estuvo de acuerdo. ¿Mi madre, que me prohibió ver incluso porno, estuvo de acuerdo en que debería estar presente en esto? Es increíble. O Eric es una especie de hechicero, o es otra cosa y necesito resolverlo correctamente."
#--- ""
