...
# "X-spanish-File: /master/game/tl/spanish/core/06_items.po\n"
# "X-spanish-File-ID: 3432\n"
...
translate spanish strings:
    ...
    new "Túnica corta, ligera, casi de seda de la más alta calidad. Hecho en China."

    # game/core/06_items.rpy:2
    old "КУПАЛЬНИК КРАСНЫЙ"
    new "TRAJE DE BAÑO ROJO"
    ...
    new "Traje de baño para aquellos que no se avergüenzan de su cuerpo. Esconde solo las zonas más íntimas. Todo lo demás está abierto al sol y a los ojos de los demás."
    ...
    new "Un gran regalo para una chica que quiere causar sensación en una fiesta o discoteca."
    ...
    new "Una novela sobre el amor prohibido entre una secretaria y su jefe, llena de amor, pasión, emociones y... Misticismo."
    ...
    new "¡Una nueva novela erótica, incluida en el Top 10 de las mejores novelas y cuentos de Estados Unidos!"
    ...
    new "En la finca de Carter, hermosas chicas son entrenadas para convertirse en esposas perfectas para las personas más poderosas del mundo."

    # game/core/06_items.rpy:2
    old "КНИГА ОРГАЗМОВ"
    new "LIBRO DE ORGASMOS"

    # game/core/06_items.rpy:2
    old "Что получится, если собрать самые горячие истории об оргазмах от 69 различных авторов?"
    new "¿Qué sucede si recopilas las historias más populares sobre orgasmos de 69 autores diferentes?"
    ...
    new "Es una historia sobre la dominación y la sumisión. La historia de una hermosa niña llamada O."
    ...
    new "Una pequeña escalón que te permite obtener lo que no tienes suficiente crecimiento"
    ...
    new "El libro habla sobre formas de crear sus propios sitios que funcionan en cualquier dispositivo."
    ...
    new "Cómoda camiseta y pantalones cortos. No son calurosos en las sofocantes noches de verano, e igual de acogedores durante todo el año."
    ...
    new "Camisa y bragas translúcidas. El estilo ajustado enfatiza todas las ventajas y curvas de la figura, y el encaje ligero dará aún más sexualidad."
    ...
    new "Un pequeño conjunto de cosméticos para el uso diario. Para las mujeres, solo lo mejor..."
    ...
    new "Chocolate \"Ritter Sport\" (4 piezas)"
    ...
    new "Dulces \"Raffaello\" (24 piezas)"
    ...
    new "Dulces \"Ferrero Rocher\" (24 piezas)"
    ...
    new "La preparación ligera y bien absorbida para acelerar el bronceado tiene propiedades hidratantes y protectoras. Recomendado para su uso en la playa y en el solárium."

    # game/core/06_items.rpy:2
    old "МУЖСКИЕ МАЙКА И ШОРТЫ"
    new "CAMISETAS Y PANTALONES CORTOS PARA HOMBRE"

    # game/core/06_items.rpy:2
    old "Свободный и лёгкий летний комплект одежды на каждый день."
    new "Juego de ropa de verano gratis y ligero para todos los días."

    # game/core/06_items.rpy:2
    old "КОНФЕТЫ С ЛИКЁРОМ"
    new "CARAMELO CON LICOR"
    ...
    new "Chocolates con licor. Sabores únicos esconden el sabor del alcohol. Anímate perfectamente. Muy fuerte."

    # game/core/06_items.rpy:2
    old "КОМПЛЕКТ ТЁМНОГО НИЖНЕГО БЕЛЬЯ"
    new "CONJUNTO DE ROPA INTERIOR OSCURA"

    # game/core/06_items.rpy:2
    old "Отличное нижнее бельё тёмного цвета. Отличный подарок для любимой девушки."
    new "Excelente ropa interior de color oscuro. Un gran regalo para tu novia."
    ...
    new "El libro trata sobre todo lo relacionado con el sexo. Ideal para educar a la generación más joven."
    ...
    new "Cámara profesional con lente. No es nuevo, pero está en excelentes condiciones. Adecuado tanto para principiantes como para profesionales."

    # game/core/06_items.rpy:2
    old "КОРОТКАЯ ПИКАНТНАЯ СОРОЧКА"
    new "CAMISA CORTA PICANTE"

    # game/core/06_items.rpy:2
    old "Соблазнительная чёрная сорочка выполнена из эластичного тюля. В комплект так же входят трусики-стринги."
    new "La seductora camisa negra está hecha de tul elástico. El kit también incluye bragas-tangas."

    # game/core/06_items.rpy:2
    old "ЧЁРНОЕ СЕКСУАЛЬНОЕ БОДИ"
    new "BODYSUIT NEGRO SEXY"

    # game/core/06_items.rpy:2
    old "Прозрачное сетчатое боди с открытой спиной чёрного цвета."
    new "Bodysuit de malla transparente con una espalda abierta de color negro."

    # game/core/06_items.rpy:2
    old "ЧЁРНОЕ КРУЖЕВНОЕ БОДИ"
    new "BODYSUIT DE ENCAJE NEGRO"

    # game/core/06_items.rpy:2
    old "Женское сексуальное нижнее бельё с кружевным узором по краям."
    new "Ropa interior sexy de mujer con un patrón de encaje alrededor de los bordes."

    # game/core/06_items.rpy:2
    old "СПОРТИВНЫЕ ЛИФ И МИНИ ШОРТЫ"
    new "CORPIÑO DEPORTIVO Y MINI SHORTS"

    # game/core/06_items.rpy:2
    old "Удобная, открытая и лёгкая одежда для занятий спортом. Так же она прекрасно подойдёт для отдыха на природе."
    new "Ropa cómoda, abierta y ligera para hacer deporte. También es perfecto para la recreación al aire libre."

    # game/core/06_items.rpy:2
    old "ФИЛЬМ \"ЦВЕТ НОЧИ\" 1994 ГОД"
    new "PELÍCULA \"COLOR OF NIGHT\" 1994"
    ...
    new "Bruce Willis en el papel de un psicólogo de Nueva York que perdió a un paciente: se tiró por la ventana justo durante la sesión. Para recuperarse, se va a Los Ángeles con su amigo, con quien estudiaron juntos..."

    # game/core/06_items.rpy:2
    old "КОМПРОМАТ НА ЭРИКА"
    new "Pruebas comprometedoras de eric"
    ...
    new "Imágenes de cómo Eric por la noche se masturbaba primero con Alice en la ventana de su habitación, y luego en su habitación."

    # game/core/06_items.rpy:2
    old "ЧЁРНЫЙ КОЖАНЫЙ КОСТЮМ ДЛЯ РОЛЕВЫХ ИГР"
    new "TRAJE DE CUERO NEGRO PARA JUEGOS DE ROL"
    ...
    new "El látigo refrescará y diversificará su relación. Una bofetada al final del acto revelará un compañero valiente y mezquino. Un juguete sexual abrirá los reinos del BDSM real."
