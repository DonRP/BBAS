...
translate crowdin strings:
    ...
    new "Un nuevo producto está disponible en la tienda en línea."

    # game/core/core.rpy:817
    old "{i}идти на веранду{/i}"
    new "{i}ir a la terraza{/i}"
...
"Правда есть небольшой нюанс, благодаря которому Алиса и согласилась на это... Я пообещал, что отшлёпаю её нежно. Да уж, будет не просто устоять и не влепить по её попке за то, как стервозно она себя вела..."
    new "¡Resultó interesante! Por el bien del interés, le dije a Alice que ya no quiero interceder por ella cuando sea castigada, pero que estoy listo para seguir haciéndolo si acepta que le pegue.\n"
