...
# "X-spanish-File: /master/game/tl/spanish/events/alice_cam.po\n"
# "X-spanish-File-ID: 3474\n"
...
translate spanish cam0_alice_sleep_night_b8a0158a:

    # Max_01 "{m}Ночное шоу закончилось. Теперь Алиса спит...{/m}"

# game/events/alice_cam.rpy:53
translate spanish cam0_alice_sleep_night_a01b9b3d:
...
translate spanish cam0_alice_sleep_night_6094a2c7:
...
translate spanish cam0_alice_sleep_night_8219b103:
...
translate spanish cam0_alice_sleep_night_2098780c:
...
translate spanish cam0_alice_sleep_night_d77d346a:
...
translate spanish cam0_alice_sleep_night_f2542dc5:
...
translate spanish cam0_alice_dressed_shop_44c5fd4f:

    # Max_04 "{m}Какая соблазнительная попка у неё... Уверен, зрителям это нравится!{/m}"

# game/events/alice_cam.rpy:373
translate spanish cam0_alice_dressed_friend_8b130390:

    # Max_09 "{m}Ничего интересного я здесь уже не увижу, Алиса полностью оделась.{/m}"

# game/events/alice_cam.rpy:391
translate spanish cam0_alice_dressed_friend_363c2c1a:

    # Max_07 "{m}Ага! Алиса наряжается, чтобы куда-то отправиться...{/m}" nointeract

# game/events/alice_cam.rpy:402
translate spanish cam0_alice_dressed_friend_1f916806:

    # Max_02 "{m}О да! Сейчас она совсем голенькая...{/m}" nointeract

# game/events/alice_cam.rpy:413
translate spanish cam0_alice_dressed_friend_e872a8d5:
...
translate spanish cam0_alice_dressed_friend_24dcb435:
...
translate spanish cam0_alice_dressed_friend_6dade498:

    # Max_04 "{m}Трусики хорошо смотрятся на её попке. Но без них было бы лучше...{/m}"

# game/events/alice_cam.rpy:431
translate spanish cam0_alice_dressed_club_8b130390:

    # Max_09 "{m}Ничего интересного я здесь уже не увижу, Алиса полностью оделась.{/m}"

# game/events/alice_cam.rpy:443
translate spanish cam0_alice_dressed_club_0a40c953:

    # Max_07 "{m}Ага! Алиса наряжается, чтобы отправиться в клуб...{/m}" nointeract

# game/events/alice_cam.rpy:454
translate spanish cam0_alice_dressed_club_1f916806:

    # Max_02 "{m}О да! Сейчас она совсем голенькая...{/m}" nointeract

# game/events/alice_cam.rpy:464
translate spanish cam0_alice_dressed_club_e872a8d5:

    # Max_01 "{m}Трусики хорошо смотрятся на её попке. Вот только быть их на ней не должно... Считай, сестрёнка, ты попала!{/m}"

# game/events/alice_cam.rpy:468
translate spanish cam0_alice_dressed_club_888581eb:
...
translate spanish cam0_alice_dressed_club_79e8edcf:
...
translate spanish cam0_alice_rest_morning_fae5dd2e:

    # Max_01 "{m}Алиса валяется со своим ноутбуком. Смотрится неплохо...{/m}"

# game/events/alice_cam.rpy:490
translate spanish cam0_alice_dishes_a2a73221:
...
translate spanish cam0_alice_read_b7322552:

    # Max_07 "{m}Так, Алиса просто читает. Не особо интересно.{/m}"

# game/events/alice_cam.rpy:501
translate spanish cam0_alice_read_d43fe115:
...
translate spanish cam0_alice_rest_evening_e854f0c8:
...
translate spanish cam0_alice_rest_evening_822de6bf:
...
translate spanish cam1_alice_bath_d245ef91:

    # Max_09 "{m}Алисы не видно через эту камеру... Может посмотреть через другую?{/m}"

# game/events/alice_cam.rpy:684
translate spanish cam0_alice_blog_lingerie_a9cbbaee:

    # Max_02 "{m}Сегодня Алиса занимается блогом в нижнем белье! Это уже поинтереснее...{/m}"

# game/events/alice_cam.rpy:686
translate spanish cam0_alice_blog_lingerie_62f092f7:
...
translate spanish cam0_alice_after_club_d245ef91:

    # Max_09 "{m}Алисы не видно через эту камеру... Может посмотреть через другую?{/m}"

# game/events/alice_cam.rpy:697
translate spanish cam0_alice_after_club_fb8560fe:

    # Max_09 "{m}Алисы не видно через эту камеру...{/m}"

# game/events/alice_cam.rpy:704
translate spanish cam0_alice_after_club_8af01322:

    # Max_04 "{m}Не спеши, Алиса. Вытирайся помедленнее...{/m}"

# game/events/alice_cam.rpy:710
translate spanish cam0_alice_after_club_d9457482:

    # Max_05 "{m}Это самый лучший ракурс, чтобы понаблюдать за тем, как Алиса принимает ванну! Заглядение...{/m}"

# game/events/alice_cam.rpy:723
translate spanish cam1_alice_after_club_bc1436f8:

    # Max_01 "{m}Алиса вернулась из клуба.{/m}"

# game/events/alice_cam.rpy:728
translate spanish cam1_alice_after_club_d245ef91:

    # Max_09 "{m}Алисы не видно через эту камеру... Может посмотреть через другую?{/m}"

# game/events/alice_cam.rpy:740
translate spanish cam0_blog_with_Eric_2dbcbfe9:

    # Max_09 "{m}Эрик о чём-то разговаривает с Алисой. И развалился так, как будто это его комната...{/m}"
    Max_09 " {m} Eric está hablando con Alice sobre algo. Y se acostó como si fuera su habitación... {/ m}"

# game/events/alice_cam.rpy:744
translate spanish cam0_blog_with_Eric_f539e64b:

    # Max_08 "{m}Ого! Да она при нём, похоже, переодеваться вздумала! Что сказать, Эрик умеет добиваться своего...{/m}"
    Max_08 " {m} ¡Parece que se está cambiando de ropa delante de él! ¿Qué puedo decir? Eric sabe salirse con la suya... {/ m}"

# game/events/alice_cam.rpy:749
translate spanish cam0_blog_with_Eric_dcf61634:
    ...
    Max_01 " {m} ¡Alice hermosa y desnuda! Le dije a Eric que no mirara, solo que definitivamente él está mirando a través de sus dedos... ¡Ciertamente me arriesgo a acercarme tanto a mirar a una Alice desnuda! {/ M}"

# game/events/alice_cam.rpy:753
translate spanish cam0_blog_with_Eric_d27dde4d:
    ...
    Max_07 " {m} Uhhhh... ¡Alice se toma su tiempo para esconder sus deliciosas tetas debajo de su mono! Mmmm, ¡tal vez se dio cuenta de que Eric estaba mirando a escondidas de todos modos y se burlaba de él así! Y no sabe que él también se está burlando de mí... {/ m}"

# game/events/alice_cam.rpy:758
translate spanish cam0_blog_with_Eric_c1401911:

    # Max_09 "{m}Понятно всё с вами, Алиса села на шею Эрику, а он и рад. Эх, Алиса... надеюсь, ты знаешь, что делаешь...{/m}"
    Max_09 " {m} Entiendo lo que está pasando entre ustedes dos, Alice está en el cuello de Eric y él está feliz de hacerlo. Oh, Alice... espero que sepas lo que estás haciendo... {/ m}"

# game/events/alice_cam.rpy:787
translate spanish cam0_blog_with_Eric_4181192f:
    ...
    Max_08 " {m} Eric está en la habitación de Alice hoy. Parece que está tratando de ayudar con el blog... Pero en realidad, solo lo hace para ver a Alice en ropa interior, lo sé... {/ m}"
