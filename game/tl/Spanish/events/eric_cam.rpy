...
translate crowdin cam0_eric_resting_b4d3f901:
    ...
    Max_01 " {m} Parece que la medicina mezclada con la comida de Eric arruinó su estado de ánimo y no se arriesga a ir con mi hermana... ¡Con eso contaba! {/ M}"
...
translate crowdin cam0_sexed_lisa_451f5f08:
    ...
    Max_08 " {m} Lo sentimos, las cámaras no transmiten sonido. ¡Definitivamente tendrás que preguntarle a Lisa de qué estaban hablando! {/ M}"
...
translate crowdin cam0_sexed_lisa_71c1a2f8:
    ...
    Max_07 " {m} Lisa vino a la clase de su mamá y Eric. Veamos qué pasa... {/ m}"
...
translate crowdin cam0_sexed_lisa_c0ac64d9:
    ...
    Max_09 " {m} ¡Aquí está Eric! Está jodido... Me pregunto qué le están diciendo. {/ M}"
...
translate crowdin cam0_sexed_lisa_91d200d1:
    ...
    Max_08 " {m} Sí, el idiota se fue... Y Eric persuadió a mamá para que hiciera todo esto... {/ m}"

# game/events/eric_cam.rpy:285
translate crowdin cam0_sexed_lisa_71c1a2f8_1:

    # Max_07 "{m}Лиза пришла на урок к маме и Эрику. Посмотрим, что будет...{/m}"
    Max_07 "{m}Lisa vino a la lección a su madre y Eric. Veremos qué pasa... {/m}"
...
translate crowdin cam0_sexed_lisa_525949f3:
    ...
    Max_09 " {m} ¡Mamá esta frente a Lisa y ya está masturbando a Eric como debería ser! Me pregunto qué le están diciendo al mismo tiempo. {/ M}"
...
translate crowdin cam0_sexed_lisa_0dd5dbf3:
    ...
    Max_08 "{m}sí, mamá eleva el grado mostrando sus hermosos senos... ¡Y Eric persuadió a mama para que hiciera todo esto!{/i}"
...
translate crowdin cam0_sexed_lisa_43160aa4:
    ...
    Max_09 " {m} ¿Masturbar a Eric frente a Lisa con fines educativos? Eso sí, una cosa común, no hagas caso… me pregunto ¿qué le están diciendo ahí? {/ M}"
...
translate crowdin cam0_sexed_lisa_36fcd85f:
    ...
    Max_08 " {m} ¡Oh, me encantaría! Solo pensar en las manos de mi madre masajeando suavemente mis bolas me dan ganas de correrme... {/ m}"
...
translate crowdin cam0_sexed_lisa_4bfb346c:
    ...
    Max_09 " {m} Masturbarse y masturbarse... supongo que se están consolidando. ¡¿Cuántas veces?! {/ M}"
...
translate crowdin cam0_sexed_lisa_6918e27b:
    ...
    Max_08 " {m} Oh, Eric se derrumbó y acabo... Aunque, apenas. Lo más probable es que decidieran mostrarle a Lisa de qué se trataba. {/ M}"
...
translate crowdin cam0_eric_ann_resting_cb75645d:
    ...
    Max_02 " {m} Parece que hoy no hay planes para follar... ¡Me pregunto por qué sería así! {/ M}"
...
translate crowdin cam0_eric_sleep_bce0a0b5:
    ...
    Max_07 " {m} Ojalá no le agregué demasiado sedante... Lo principal es que ahora no molesta a nadie. {/ M}"
...
translate crowdin cam0_eric_ann_try_fucking_5da5d134:
    ...
    Max_01 " {m} ¿No vale la pena? Bueno, no pasa nada... Pero es bueno saber que esto está sucediendo debido a mis acciones. {/ M}"
