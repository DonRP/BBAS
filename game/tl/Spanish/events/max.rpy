...
# "X-spanish-File: /master/game/tl/spanish/events/max.po\n"
# "X-spanish-File-ID: 3492\n"
...
translate spanish StartDialog_e88dfdc8:
...
translate spanish Shower_d716938a:
...
translate spanish Box_911e2e27:
...
translate spanish create_site_4c292724:
...
translate spanish create_site_2b30be60:
...
translate spanish about_cam_42f3e467:
...
translate spanish about_blog_b55fbee5:

    # Max_00 "{m}И зачем я только что-то изучал...{/m}"

# game/events/max.rpy:465
translate spanish about_secretbook_d428da7a:
...
translate spanish about_secretbook_331cf11d:
...
translate spanish about_spider_1b3b8906:

    # Max_01 "{m}Будем искать!{/m}"

# game/events/max.rpy:513
translate spanish SearchCam_29b2ce2f:
...
translate spanish SearchCam_6eab0c74:
...
translate spanish SearchCam_7c5a1bd7:
...
translate spanish DishesWashed_62001d7c:
...
translate spanish delivery1_f0fc4226:

    # Max_07 "{m}Звонок в ворота! Похоже, к нам кто-то приехал...{/m}"

# game/events/max.rpy:589
translate spanish delivery1_80685efe:

    # Sam_00 "Здравствуйте! По этому адресу на сегодня назначена доставка. Распишитесь?"
    Sam_00 "¡Hola! La entrega está programada para esta dirección hoy. ¿Firmas?"

# game/events/max.rpy:590
translate spanish delivery1_509c6af4:

    # Max_00 "Конечно! А что тут?"
    Max_00 "¡Por supuesto! ¿Qué traes aquí?"

# game/events/max.rpy:592
translate spanish delivery1_0ba1be34:

    # Max_00 "Да, то что нужно. Спасибо!"
    Max_00 "sí, eso es lo que necesitas. ¡Gracias!"

# game/events/max.rpy:619
translate spanish delivery2_f0fc4226:

    # Max_07 "{m}Звонок в ворота! Похоже, к нам кто-то приехал...{/m}"

# game/events/max.rpy:623
translate spanish delivery2_60d5c126:

    # Christine_00 "Здравствуйте! По этому адресу на сегодня назначена доставка. Распишитесь?"
    Christine_00 "¡Hola! La entrega está programada para esta dirección hoy. ¿Firmas?"

# game/events/max.rpy:624
translate spanish delivery2_509c6af4:

    # Max_00 "Конечно! А что тут?"
    Max_00 "¡Por supuesto! ¿Qué traes aquí?"

# game/events/max.rpy:626
translate spanish delivery2_0ba1be34:

    # Max_00 "Да, то что нужно. Спасибо!"
    Max_00 "sí, eso es lo que necesitas. ¡Gracias!"

# game/events/max.rpy:636
translate spanish delivery2_885c0cfc:
    ...
    Max_02 "{m}¡Tengo el body! Ahora, necesito dárselo a Alice y, sobre todo, puedo tener suerte cuando ella está involucrada en su blog. Ella ya está en ropa interior en este momento, y teniendo en cuenta que recibirá el body antes de tiempo, es posible que se cambie de ropa conmigo... {/ m}"

# game/events/max.rpy:638
translate spanish delivery2_1f5e97ce:
    ...
    Max_10 "{m}¡Tengo body! ya es demasiado tarde... Eric ya le había comprado a Alice lo que quería. Solo queda ponerlo en ebay, por lo que me devolverá al menos la mitad del costo. {/m}"

# game/events/max.rpy:649
translate spanish BookRead_9562ffab:

    # Max_00 "Пришло время почитать что-то..." nointeract
    Max_00 "Es hora de leer algo..." nointeract

# game/events/max.rpy:658
translate spanish BookRead_manual_41be558e:
...
translate spanish BookRead_manual_0826f3fe:
...
translate spanish BookRead_manual_3605e1d8:
...
translate spanish BookRead_manual_1c08c83d:
...
translate spanish BookRead_manual_bd8ad388:
    ...
    Max_00 "¡Todo, ahora todo está claro seguro! ¡Ya puedo hacer mi sitio web y transmitir una imagen a él! Pero, ¿cómo recibir un pago por ello?"

# game/events/max.rpy:678
translate spanish BookRead_sex_ed_e2e2e4d9:
...
translate spanish BookRead_sex_ed_5dc0d1da:
...
translate spanish BookRead_sex_ed_cdf53c7a:
...
translate spanish BookRead_sex_ed_58528ae0:
    ...
    Max_04 "Aquí están los últimos capítulos... Aún así, ¡el tacto es muy importante! Sí, ya lo he entendido en la práctica... ¡Oh, debería haber comprado este libro antes! Pero más vale tarde que nunca. El material ha sido asimilado y ahora puedo dárselo a Lisa."

# game/events/max.rpy:689
translate spanish BookRead_sex_ed_37326ac9:
...
translate spanish SearchSecretBook_4d6b282e:
...
translate spanish InstallCam_44699dcc:
    ...
    Max_04 "{m}Hay tantas cosas sucediendo en esta habitación... ¡Creo que al público le encantará! Lo principal es ocultar todos los cables para que Lisa no note la nueva microcámara... {/m}" nointeract

# game/events/max.rpy:786
translate spanish InstallCam_b9324e31:
    ...
    Max_04 "{m}Deja que la audiencia vea lo que Alice está haciendo en su habitación cuando no se la ve... Estaría feliz de verlo yo mismo, pero aún no tengo esa característica... {/m}" nointeract

# game/events/max.rpy:792
translate spanish InstallCam_9d11ed16:
    ...
    Max_04 "{m}Por supuesto, los eventos rara vez ocurren aquí. Pero cuando suceden, hay esto... Creo que el público estará contento con esos momentos... {/m}" nointeract

# game/events/max.rpy:799
translate spanish InstallCam_bc72cb94:
    ...
    Max_03 "{m}¡Ahora a través de ambas cámaras puedes ver todo lo más interesante! A las chicas les encanta lucirse en el espejo, y mi madre y Eric, como me di cuenta, tratan de no perder la oportunidad de follar frente al mismo espejo... ¡A mis espectadores les encantará! {/m}" nointeract

# game/events/max.rpy:805
translate spanish InstallCam_3a6027ee:
    ...
    Max_04 "{m}Por supuesto, desde el punto de vista de la moralidad, es dudoso poner una cámara en el baño. Sin embargo, aquí y así la ventana en toda la pared. Entonces, formalmente, acabo de abrir esa ventana... {/m}" nointeract

# game/events/max.rpy:811
translate spanish InstallCam_918d8b5b:
    ...
    Max_04 "{m}no sé si habrá algún uso de esta cámara... Es tan raro que algo suceda aquí... Bueno, lo dejare. Desde que me comprometí a conectar todo... {/m}" nointeract

# game/events/max.rpy:818
translate spanish InstallCam_3a93939c:

    # Max_04 "{m}Вот теперь зрители смогут насладится всеми мокрыми и блестящими красотами, происходящими во дворе...{/m}" nointeract
    Max_04 "{m}Ahora el público podrá disfrutar de todas las bellezas húmedas y brillantes que tienen lugar en el patio... {/m}" nointeract

# game/events/max.rpy:824
translate spanish InstallCam_3426c2fd:
    ...
    Max_04 "{m}Patio... Hay casi todo el tiempo alguien allí y hace algo mientras brilla el sol. Creo que aquí el público pasará el rato constantemente con la esperanza de ver a alguien con las tetas desnudas... {/m}" nointeract

# game/events/max.rpy:826
translate spanish InstallCam_7711d18e:
    ...
    Max_09 "{m}Quizás, debido a la gran área, debería instalar varias cámaras aquí para que la audiencia pueda ver mejor que sucede aquí... {/m}"

# game/events/max.rpy:860
translate spanish SearchSpider_d37d0a80:

    # Max_00 "{m}Так, нужно хорошенько рассмотреть траву...{/m}" nointeract

# game/events/max.rpy:865
translate spanish SearchSpider_1b27d19f:

    # Max_04 "Ага! Попался! Отлично..."
    Max_04 "Sí. ¡Adquirido! Es fantastico..."

# game/events/max.rpy:869
translate spanish SearchSpider_f2d13038:
...
translate spanish need_money_7d60b08e:
...
translate spanish need_money_d5c0c6aa:
...
translate spanish need_money_b39c15a3:
...
translate spanish need_money_14f2a995:
...
translate spanish cheat_money_46383d7e:
...
translate spanish cheat_money_strateg_16b9bde6:
...
translate spanish about_credit_90bb447c:
...
translate spanish about_credit_73692d65:
