...
msgstr[0] "Un nouveau produit est disponible dans la boutique en ligne."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/core.rpy:817
msgid "{i}идти на веранду{/i}"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "{i}Aller à la véranda{/i}"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/core.rpy:817
msgid "{i}не сейчас{/i}"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "{i}pas maintenant{/i}"
msgstr[1] "Ignore this. translate only: One"
