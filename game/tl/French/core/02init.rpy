...
msgstr "Ce jeu fournit un contrôle au clavier. Vous pouvez l'utiliser à tout moment. Raccourcis clavier par défaut:\n"
"F5 - Enregistrer, F8 - Charger.\n\n\n"
"En outre, lors de dialogues, 1 à 9 pour différentes options de réponse. S'il n'y a qu'une seule option, vous pouvez appuyer sur la touche [[Space].\n\n\n"
...
"Vous pouvez augmenter votre audience avec des publicités. Si rien d’intéressant ne se passe sur les caméras, le public partira. Si des moments piquants entrent dans le cadre, le public augmente.\n\n\n"
...
msgstr "Je veux te dire quelque chose sur Kira..."
