...
translate french StartDialog_069fda26:

    # Max_10 "Я чувствую себя слишком уставшим для этого. Было бы неплохо сначала вздремнуть и набраться сил..."
    Max_10 "Je me sens trop fatigué pour ça. Ce serait bien de faire une sieste d'abord et de prendre de la force..."
...
translate french Sleep_dca71115:

    # Max_19 "Как же в этом доме хорошо..."
    Max_19 "Comme cette maison est belle..."
...
translate french Wearied_dca71115:
...
translate french LittleEnergy_dca71115:

    # Max_19 "Как же в этом доме хорошо..."
    Max_19 "Comme cette maison est belle..."

# game/events/max.rpy:114
translate french Nap_89e3b066:
...
translate french Alarm_dca71115:

    # Max_19 "Как же в этом доме хорошо..."
    Max_19 "Comme cette maison est belle..."

# game/events/max.rpy:167
translate french Shower_2c708671:
...
translate french Shower_58b0fd27:
    ...
    Max_03 "Aha ! Je viens juste de remarquer qu'il y a aussi une fenêtre à l'arrière ! Et je pense que la vue de la baignoire à travers elle serait juste magnifique... Bien sûr, l'important n'est pas le bain en lui-même, mais qui va le prendre."

# game/events/max.rpy:174
translate french Shower_b6233ffc:
    ...
    Max_09 "Sauf que c'est un peu haut... Je dois obtenir quelque chose d'où il sera facile d'épier et qui n'éveillera pas, le cas échéant, de soupçons..."

# game/events/max.rpy:175
translate french Shower_b3c37b42:

    # Max_01 "Возможно подойдёт лестница, а ещё лучше стремянка. О да, пожалуй, это будет то, что нужно!"
    Max_01 "Une échelle ou, mieux encore, un escabeau peuvent convenir. Oh oui, je pense que ce serait bien ça !"

# game/events/max.rpy:190
translate french Bath_2c708671:

    # Max_19 "Всё-таки чистым быть намного лучше. Хотя не всегда хочется..." nointeract
    Max_19 "Pourtant, être propre, c’est beaucoup mieux. Bien que je ne le veux pas toujours..." nointeract

# game/events/max.rpy:196
translate french Bath_58b0fd27:

    # Max_03 "Ага! Я только сейчас обратил внимание на то, что здесь есть ещё заднее окно! И, как мне кажется, через него на ванну откроется просто шикарный вид... Конечно же дело не в самой ванне, а в том, кто будет её принимать."
    Max_03 "Aha ! Je viens juste de remarquer qu'il y a aussi une fenêtre à l'arrière ! Et je pense que la vue de la baignoire à travers elle serait juste magnifique... Bien sûr, l'important n'est pas le bain en lui-même, mais qui va le prendre."

# game/events/max.rpy:197
translate french Bath_b6233ffc:

    # Max_09 "Только вот расположено оно высоковато... Нужно достать что-то, с чего будет удобно подглядывать и что не вызовет, в случае чего, подозрений..."
    Max_09 "Sauf que c'est un peu haut... Je dois obtenir quelque chose d'où il sera facile d'épier et qui n'éveillera pas, le cas échéant, de soupçons..."

# game/events/max.rpy:198
translate french Bath_b3c37b42:

    # Max_01 "Возможно подойдёт лестница, а ещё лучше стремянка. О да, пожалуй, это будет то, что нужно!"
    Max_01 "Une échelle ou, mieux encore, un escabeau peuvent convenir. Oh oui, je pense que ce serait bien ça !"

# game/events/max.rpy:211
translate french Box_2b7f754d:

    # Max_08 "Так, мама попросила разобрать коробки. Сейчас глянем, что тут у нас..."
    Max_08 "Alors, ma mère m'a demandé de vider les cartons. Voyons ce que nous avons ici..."

# game/events/max.rpy:213
translate french Box_7d70e813:

    # Max_09 "Жаль, но все коробки пустые... Но что это такое? Какая-то камера?"
    Max_09 "C’est dommage, mais tous les cartons sont vides... Mais qu’est-ce que c’est ? Une sorte d’appareil photo?"

# game/events/max.rpy:215
translate french Box_05229898:

    # Max_01 "Тут внутри какая-то инструкция, описание... Да это скрытая камера! Любопытно, зачем она понадобилась отцу?"
    Max_01 "Il y a une sorte de manuel à l'intérieur, une description... C'est pour une caméra cachée ! Curieux, pourquoi mon père en avait besoin?"

# game/events/max.rpy:219
translate french Box_b28a0ea4:
...
translate french Notebook_2dd57a79:

    # Max_00 "Итак, чем интересным я займусь?"
    Max_00 "Alors, quelles sont les choses intéressantes que je vais faire ?"

# game/events/max.rpy:306
translate french nothing_search_8ac67f83:

    # Max_00 "Сейчас мне нечего искать..."
    Max_00 "Il n'y a rien à chercher pour moi maintenant..."

# game/events/max.rpy:314
translate french buyfood_0de2cd95:

    # Max_04 "Так... Посмотрим список продуктов... Ага. Сейчас всё закажем..."
    Max_04 "Alors... Jetons un coup d'œil à la liste des courses... Ouaip. Commandons tout maintenant..."

# game/events/max.rpy:316
translate french buyfood_e01f4c0c:

    # Max_04 "Готово. Да это же самая лёгкая задача!"
    Max_04 "C'est fait. C'est la tâche la plus facile de toutes !"

# game/events/max.rpy:319
translate french buyfood_96f7e58d:

    # Max_01 "Готово. То, что я делаю это без маминой финансовой помощи точно пойдёт мне только в плюс."
    Max_01 "C'est fait. Le fait que je fasse cela sans l'aide financière de ma mère ne peut que me profiter."

# game/events/max.rpy:353
translate french create_site_3744c5ee:
...
translate french create_site_e36c401d:
...
translate french create_site_4e1c08b2:
    ...
    Max_04 "oui ! Tout fonctionne ! Maintenant, les gens pourront aller sur mon site Web et regarder l’émission. Bien sûr, s’ils découvrent d’une manière ou d’une autre mon site... D’accord, je vais réfléchir à ce que je peux faire d’autre..."

# game/events/max.rpy:399
translate french about_cam_c0885969:

    # Max_09 "Так, любопытно... Эти камеры можно настроить так, чтобы они транслировали изображение в интернет!"
    Max_09 "Alors, curieux... Ces caméras peuvent être configurées pour diffuser l’image sur Internet!"

# game/events/max.rpy:400
translate french about_cam_3d3bce54:

    # Max_07 "Но что ещё интереснее, некоторые люди готовы платить за доступ к таким камерам..."
    Max_07 "Mais ce qui est encore plus intéressant, c’est que certaines personnes sont prêtes à payer pour accéder à de telles caméras..."

# game/events/max.rpy:401
translate french about_cam_3fd48063:

    # Max_09 "Может быть, мне сделать свой сайт и пусть люди мне платят за просмотр видео? Но я не умею ничего толком..."
    Max_09 "Peut-être devrais-je créer mon propre site Web et laisser les gens me payer pour regarder la vidéo? Mais je ne peux vraiment rien faire là maintenant..."

# game/events/max.rpy:414
translate french about_blog_d88e779b:
...
translate french about_blog_3a839884:
...
translate french about_blog_814aee55:
...
translate french about_blog_bb8942c7:
...
translate french about_blog_5af97f32:

    # Max_09 "[_text!t]" nointeract
    Max_09 "[_text!t]" nointeract

# game/events/max.rpy:446
translate french about_blog_c1ce2606:
    ...
    Max_01 "Qu'est-ce que ça veut dire ? Est-ce vraiment si simple ? C'est une question de nichons ! Peu importe le sujet du blog, c'est ce qu'il y a sur l'écran qui compte. Et s'il y a des seins là-dedans, tout est bien pour la popularité ! Mais je m'en doutais..."

# game/events/max.rpy:447
translate french about_blog_4571eb7f:

    # Max_00 "И зачем я только что-то изучал..."
    Max_00 "Pourquoi ai-je étudié quelque chose..."

# game/events/max.rpy:460
translate french about_secretbook_605b0407:
...
translate french about_secretbook_279d4103:
    ...
    Max_06 "Wow ! Ce n'est pas une simple histoire d'amour... C'est de l'érotisme. Et quelle femme ! Maintenant je comprends pourquoi Alice ne voulait pas me dire ce qu'elle lisait..."

# game/events/max.rpy:476
translate french about_spider_45c2646e:
...
translate french about_spider_624fb07e:

    # Max_00 "Ага, отлично. Выбираем наш регион, сортируем по видам пауков..."
    Max_00 "Ouais, super. Choisir ma région, trier par espèce d'araignée..."

# game/events/max.rpy:480
translate french about_spider_3be5aefa:

    # Max_00 "Так, пауки. Смотрим какие водятся в этом климате..."
    Max_00 "Ok, les araignées. Voyons ce qu'il y a sous ce climat..."

# game/events/max.rpy:481
translate french about_spider_e3aa40bf:

    # Max_00 "Так, и что у нас получается?"
    Max_00 "Alors, qu’obtenons-nous?"

# game/events/max.rpy:483
translate french about_spider_49e33bd9:
...
translate french about_spider_5170efbe:
...
translate french about_spider_883f72be:
    ...
    Max_04 "Voilà, super ! Elles se camouflent parfaitement la nuit, ce qui signifie qu'elles ne sont pas visibles, mais dès que le soleil commence à réchauffer le sol, elles rampent hors de l'herbe pour attraper leur proie. Et c'est vers 10 ou 11 heures ?"

# game/events/max.rpy:492
translate french about_spider_0e3e8b40:

    # Max_01 "Будем искать!"
    Max_01 "Je continuerais à chercher !"

# game/events/max.rpy:508
translate french SearchCam_67b6130b:

    # Max_04 "Ого! Вот же она! Кто-то её так хорошо запрятал в стену, что найти камеру можно только точно зная, что ищешь..."
    Max_04 "Wow ! Elle est là ! Quelqu'un l'a si bien cachée dans le mur que je ne pouvais pas trouver la caméra que si je sais exactement ce que je cherche..."

# game/events/max.rpy:509
translate french SearchCam_140db024:
    ...
    Max_09 "Alors... Mais elle n'est connecté à rien pour le moment. Apparemment, mon père avait l'habitude de garder un œil sur les progrès de la construction et de la rénovation, mais maintenant il n'y a plus personne pour regarder et rien à faire..."

# game/events/max.rpy:510
translate french SearchCam_9487a2c0:

    # Max_04 "Но если её подключить, то можно подглядывать и за кое-чем другим. Вот только нужно во всём как следует разобраться!"
    Max_04 "Mais si je la branches, je peux regarder autre chose aussi. J'ai juste besoin de tout régler !"

# game/events/max.rpy:518
translate french SearchCam_529c107e:

    # Max_14 "Кажется, здесь нет никаких камер... Нужно поискать в самом доме!"
    Max_14 "Il ne semble pas y avoir de caméras... Je dois regarder dans la maison elle-même !"

# game/events/max.rpy:520
translate french SearchCam_c5169ba0:

    # Max_14 "Кажется, здесь нет никаких камер... Может быть, стоит поискать в другой комнате?"
    Max_14 "Il ne semble pas y avoir de caméras... Je devrais peut-être regarder dans l'autre pièce?"

# game/events/max.rpy:532
translate french ClearPool_f0dc1508:

    # Max_11 "Эх... Не лёгкая это работа, но нужно отработать те деньги, что мама уже заплатила..."
    Max_11 "Eh... Ce n'est pas un travail facile, mais je dois travailler avec l'argent que maman a déjà donné..."

# game/events/max.rpy:535
translate french ClearPool_62cb38c0:

    # Max_01 "Эх... Работа нудная, но важно, чтобы мои девочки плескались в чистой водичке. И теперь, я слежу за этим сам."
    Max_01 "Eh... C'est un travail fastidieux, mais il est important que mes filles puissent barboter dans de l'eau propre. Et maintenant, je les regarde moi-même."

# game/events/max.rpy:555
translate french DishesWashed_cedc9161:
...
translate french delivery1_919500cd:

    # Max_07 "Звонок в ворота! Похоже, к нам кто-то приехал..."
    Max_07 "Appel à la porte ! On dirait que quelqu'un est venu nous voir..."
...
translate french delivery2_919500cd:
...
translate french SearchSecretBook_390d326c:
...
translate french SearchSecretBook_pillow_fdc18f7e:
...
translate french SearchSecretBook_bed_893f346c:
...
translate french SearchSecretBook_table_f75e7ca0:
...
translate french SearchSecretBook_wardrobe_ef3ccc0f:
    ...
    Max_04 "Il est là ! Et pourquoi le cacher comme ça? Curieuse couverture. Je me souviendrai du nom. Je me demande de quoi parle ce livre. Peut-être le googler ? Bon, c'est ça, je dois y aller..."

# game/events/max.rpy:762
translate french InstallCam_b5c9650c:

    # Max_00 "Здесь уже есть камера. Пожалуй, стоит установить её в другом месте."
    Max_00 "Il y a déjà une caméra ici. Je devrais peut-être l'installer ailleurs."
...
translate french SearchSpider_19279e48:
...
translate french SearchSpider_88937e9a:
    ...
    Max_00 "Il n'y a rien de tel qu'une grande araignée effrayante... Peut-être que j'ai surpassé tout le monde et que je devrais attendre un jour ou deux?"

# game/events/max.rpy:872
translate french HideSpider_59b81ead:

    # Max_00 "Я могу не успеть как следует припрятать паука, прежде чем Алиса вернется из ванной."
    Max_00 "Je n'aurai peut-être pas le temps de cacher l'araignée avant qu'Alice ne revienne dans la salle de bain."

# game/events/max.rpy:877
translate french HideSpider_14a01e28:
...
translate french HideSpider_dbcd96db:

    # Max_00 "Что ж, будем надеяться, что паук не сбежит до того, как Алиса ляжет спать..."
    Max_00 "Eh bien, espérons que l’araignée ne s’échappe pas avant qu’Alice ne se couche..."
...
translate french SearchCigarettes_b89e2d47:

    # Max_09 "Так... Где же Алиса спрятала сигареты сегодня?"
    Max_09 "Alors... Où Alice a-t-elle caché ses cigarettes aujourd’hui ?"

# game/events/max.rpy:949
translate french SearchCigarettes_no_34602f75:
...
translate french SearchCigarettes_yes_b172b515:
...
translate french need_money_abb42405:

    # Max_10 "Сегодня уже четверг. Последний день когда я могу заказать подарки девчонкам, чтобы опередить Эрика."
    Max_10 "C'est déjà jeudi. Le dernier jour où je peux commander des cadeaux pour les filles pour devancer Eric."

# game/events/max.rpy:981
translate french need_money_ac403840:

    # Max_11 "Нужно скорее купить платье Алисе и купальник для Лизы, а денег у меня хватает лишь на что-то одно..."
    Max_11 "je dois acheter la robe et le maillot de bain d’Alice et Lisa dès que possible, et j’ai assez d’argent que pour une chose..."

# game/events/max.rpy:983
translate french need_money_3eda5efb:

    # Max_11 "Нужно скорее купить платье Алисе и купальник для Лизы, а денег мне не хватит даже на что-то одно..."
    Max_11 "je dois acheter la robe et le maillot de bain d’Alice et Lisa dès que possible, et je n’aurais pas assez d’argent même pour une chose..."

# game/events/max.rpy:988
translate french need_money_d141bd06:

    # Max_11 "Я уже купил платье Алисе, но на купальник для Лизы мне не хватит денег..."
    Max_11 "j’ai déjà acheté la robe d’Alice, mais je n’ai pas assez d’argent pour un maillot de bain pour Lisa..."

# game/events/max.rpy:993
translate french need_money_82767ab2:

    # Max_11 "Я уже купил купальник для Лизы, но на платье Алисе мне не хватит денег..."
    Max_11 "j’ai déjà acheté un maillot de bain pour Lisa, mais je n’ai pas assez d’argent sur la robe d’Alice..."

# game/events/max.rpy:997
translate french need_money_e2c6bbaf:

    # Max_08 "Сайт у меня есть и уже приносит какую-то прибыль, но нужно время, чтобы раскрутить его."
    Max_08 "J'ai un site web et il génère déjà quelques revenus, mais il faut du temps pour le mettre en place et le faire fonctionner."

# game/events/max.rpy:999
translate french need_money_4caca393:

    # Max_08 "К сожалению, у меня нет источника доходов, все мои деньги я получаю только от мамы. Ну и от Алисы ещё могу..."
    Max_08 "Malheureusement, je n'ai aucune source de revenus, tout mon argent vient uniquement de ma mère. Et d'Alice un peu aussi..."

# game/events/max.rpy:1000
translate french need_money_e2987b4e:

    # Max_09 "Нужно поискать какую-нибудь информацию в интернете, может есть возможность получить кредит."
    Max_09 "Je devrais chercher des informations sur Internet, peut-être y a-t-il une possibilité d'obtenir un prêt."
...
translate french about_credit_235ff689:
    ...
    Max_00 "Alors, cherchons où un type simple peut trouver de l'argent..."

# game/events/max.rpy:1033
translate french about_credit_3db8ce1c:

    # Max_09 "Это не подходит... Здесь нужно иметь официальное трудоустройство на работе..."
    Max_09 "Ça ne va pas... Je dois avoir un emploi officiel..."

# game/events/max.rpy:1034
translate french about_credit_ed51b8a7:

    # Max_07 "Ага, а вот это может и подойти - краткосрочные займы начинающим интернет-предпринимателям. О, да, это про меня..."
    Max_07 "Oui, et ça pourrait marcher - des prêts à court terme pour les jeunes entrepreneurs d'Internet. Oh, oui, c'est moi..."

# game/events/max.rpy:1035
translate french about_credit_189e301b:
...
translate french about_credit_6a66dabb:
    ...
    Max_05 "S'inscrire... Je donne mes coordonnées... Mon propre site web comme source de revenus... C'est fait !"

# game/events/max.rpy:1039
translate french about_credit_aae7fcb4:

    # Max_02 "Теперь я могу взять кредит, если срочно понадобятся деньги. Главное вовремя его погасить, чтобы проблем не было..."
    Max_02 "Je peux maintenant contracter un prêt si j'ai un besoin urgent d'argent. L'essentiel est de le rembourser à temps pour qu'il n'y ait pas de problèmes..."

# game/events/max.rpy:1042
translate french about_credit_a7187d9d:

    # Max_16 "Вот чёрт, а у меня нет никакого проекта! Получается, что денег мне никто не даст."
    Max_16 "Oh, merde, et je n'ai pas de projet! Il s'avère que personne ne veut me donner d'argent."

# game/events/max.rpy:1052
translate french getting_load_f9d89f7f:
...
translate french return_part_loan_4564f05f:
