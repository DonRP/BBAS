...
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Pendant le jeu, pendant les dialogues et autres actions, vous pouvez découvrir de nouvelles 'possibilités'. Leurs mécanismes ressemblent un peu aux 'quêtes' ou aux 'quêtes' d'autres jeux, mais il y a quelques différences.\n\n\n"
...
msgid_plural "Ignore this. translate only: One"
msgstr[0] "J'ai la chose délicieuse que je vous ai promis!"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Насчёт ванны ночью..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Quant à la salle de bain durant la nuit ..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "А ты умеешь целоваться?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Sais-tu comment embrasser?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Я слышал, Эрик тебе новое бельё собирается купить?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "J’ai entendu dire qu’Eric allait t'acheter de nouveaux sous-vêtements?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Покажешь боди, которое тебе Эрик купит?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Peux-tu me montrer ce qu’Eric va t'acheter ?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Хотел узнать, хорошо ли тебе сидится?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Je voulais savoir si ça t'allais bien?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Не слабо тебя отшлёпали!"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Pas doucement, tu as enjambé!"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Ты не передумала о наказаниях?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Tu n'as pas pensé à la punition?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Отшлёпать тебя сейчас или..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Des fessées maintenant oubien ..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Пора отшлёпать одну милую попку!"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Il est temps de donner la fessée à ce cul mignon!"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Тебе помочь накрыть на стол?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Peux-tu m'aider à mettre la table?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Как ты после случившегося?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Comment ça va après ça?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Я пришёл извиниться за то, что было утром. Я больше не буду."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Je suis venu m’excuser pour ce qui s’est passé ce matin. Je ne le referais plus."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Я снова подглядывал. Извини."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "J’ai jeté un coup d’œil à nouveau. Pardon."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Ну давай, можешь меня наказывать..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Aller, tu peux me punir..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Я выбираю наказание от тебя..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Je choisis la punition par toi..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Мам, дай денег, пожалуйста..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Maman, donne-moi de l’argent, s’il te plaît..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Я продукты заказал!"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "J’ai commandé les produits!"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Мам, бассейн чист!"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Maman, la piscine est propre !"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Что смотришь?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Que regardes-tu?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Насчёт случая с Лизой..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Quant au cas de Lisa..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Мам, а как учатся целоваться?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Maman, comment apprends-tu à embrasser?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Мам, Кира отправила меня к тебе..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Maman, Kira m’a envoyé vers toi..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "С тобой можно?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Puis-je rester avec toi?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Я присоединюсь?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Vais-je m’inscrire?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Мам, нужно поговорить об Оливии."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Maman, je dois parler d'Olivia."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Мам, ты подумала об Оливии?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Maman, tu as pensé à Olivia?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Мне нужны деньги..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "J’ai besoin d’argent..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Эрик, мы же договорились!"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Eric, nous étions d’accord !"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Я хотел поговорить о Кире..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Je voulais parler de Kira..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Мою премию за помощь с Лизой!"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Mon prix pour avoir aidé Lisa!"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Чтобы на маме были не только очки для сна, но и чулки!"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Pour maman, il n'y avait pas seulement des lunettes pour dormir, mais aussi des bas!"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Чтобы на маме были только очки для сна!"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Pour que maman n'ait que des lunettes pour dormir!"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Вот деньги, чтобы ты не лез к Лизе..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Voici l’argent pour que tu n’arrivais pas à donner à Lisa..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "У меня нет денег, чтобы ты не лез к Лизе."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Je n’ai pas l’argent que tu devais à Lisa."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Да тут всегда хорошая погода..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Oui, il fait toujours beau..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Ага, как всегда..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Oui, comme toujours..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Да, шикарная!"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Oui, magnifique!"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Кира, мне нужно научиться целоваться..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Kira, j’ai besoin d’apprendre à embrasser..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Ну как, ты с мамой-то поговорила?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Eh bien, avez-vous parlé à ta mère?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Как отдыхается, тётя Кира?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Ou tante Kira dort-elle?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Насчёт фотосессии..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Quant à la séance photo..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Понравились фотографии?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Tu aimes les photos ?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Не злишься на меня, тётя Кира?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Es-tu en colère contre moi, tante Kira?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Так когда будем снова фотографироваться, тётя Кира?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Alors, quand allons-nous refaire des photos, tante Kira?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Тётя Кира, когда ты уже с мамой поговоришь?!"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Tante Kira, quand parleras-tu à ma mère?!"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Я хотел спросить про тот случай из детства мамы..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Je voulais poser des questions sur cet incident d’enfance avec ma mère..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Расскажи уже про тот случай из детства мамы..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Parlez-nous de cet incident de ton enfance avec ta mère ..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Когда будет новая фотосессия, тётя Кира?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Quand y aura-t-il une nouvelle séance photo, tante Kira?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Уже слышала новость, тётя Кира?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Tu as entendu la nouvelle, tante Kira?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "О школе..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "À propos de l’école..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "А ты чего так загораешь?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Et pourquoi prenez-vous un bain de soleil comme ça?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Насчёт твоего парня..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Quant à votre petit ami..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Насчёт этого случая утром..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Quant à cet incident de ce matin..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Хотел поговорить о Большом Максе..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Je voulais parler de 'Grand Max'..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "А ты у нас шалунья, оказывается..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Et vous êtes un, il se trouve que..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Насчёт успеваемости..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Quant à la performance académique..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Помочь с уроками?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "De l’aide pour les leçons?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "У тебя странный вид..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Tu as un regard étrange..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Может всё-таки поделишься своими переживаниями по поводу Алисы?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Peux-tu me donner ton sentiment à propos d’Alice?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Массаж рук заказывала?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "As-tu envie d'un massage?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Ну что, Лиза, готова?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Lisa es-tu prête ?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Ну что, готова?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Est-ce que tu as fini?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Лиза, ты же любишь читать?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Lisa, aimes-tu lire?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Лиза, у меня для тебя особая книжка..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Lisa, j’ai un livre spécial pour toi..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Рассказывай, что делали?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Dis-nous ce que tu as fait?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Ну так и чему же тебя учили?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Alors, qu’est-ce que tu as appris?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Что новенького было на уроке?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Qu’y a-t-il de nouveau en classe ?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Что нового мама с Эриком тебе рассказали?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Qu’est-ce que maman et Eric t'as dit?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Что нового узнала на уроке у мамы и Эрика?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Qu’as-tu appris en classe de ma mère et d’Eric?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "{i}урок поцелуев{/i}"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "{i}leçon de baiser{/i}"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Насчёт Алекса..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Quant à Alex..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Есть успехи с Оливией?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Un peu de succès avec Olivia?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Что-нибудь узнала про Оливию?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "As-tu appris quelque chose sur Olivia ?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Ну так, что там с трусиками Оливии?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Alors, que se passe-t-il avec la culotte d’Olivia?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Ты позвала Оливию к нам?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Tu m'as appelé Olivia ?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Ну как, получилось рассказать всё Оливии?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Eh bien, comment se fait-il que tu as tout raconter à Olivia ?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Нравится, что я спасаю твою попку от наказания?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Comme ça je sauve ton cul de la punition?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Учтите, я испытываю... некоторый подъём!"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Tu vois, j'acquière de l’expérience... un peu d’évolution!"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Пошепчемся немного о моей сестрёнке?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Devrions-nous parler de ma petite sœur?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Что новенького, Оливия?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Quoi de neuf, Olivia?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Рад тебя видеть, Оливия!"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Heureux de te voir, Olivia!"
msgstr[1] "Ignore this. translate only: One"
...
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Lisa, qu'est-ce que tu as fait?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Мама разрешила!"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Maman l’a permis!"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Кстати, а как тебе та книжка, которую я дарил?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Au fait, comment aimes-tu le livre que je t'ai donné?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Можно вместе с тобой книжку почитать?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Je peux lire le livre avec toi?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Можно к тебе присоединиться?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Je peux me joindre à toi?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "А у меня есть крем для загара. Хотите?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "J'ai de la crème solaire. Tu en veux?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Давайте, я намажу вас кремом для загара?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Aller, je te mets de la crème solaire?"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:139
msgid "Вам дать крем для загара?"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Veux-tu de la crème solaire?"
msgstr[1] "Ignore this. translate only: One"
...
msgid "Электроника"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Électronique"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:273
msgid "Товары 18+"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Produits pour plus de 18"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:273
msgid "Косметика"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Cosmétiques"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:273
msgid "Украшения"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Décorations"
msgstr[1] "Ignore this. translate only: One"
...
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Et j’ai ce dont tu rêvais..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:284
msgid "У меня для тебя подарок {i}(Халат){/i}"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "J’ai un cadeau pour toi {i}(Peignoir){/i}"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:284
msgid "У меня для тебя вкусняшка!"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "J’ai un délicieux cadeau pour toi!"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:284
msgid "У меня есть кое-что запрещённое..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "J’ai quelque chose d’interdit..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:284
msgid "Угадай: маленькое, чёрненькое..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Devines quoi : petit, noir..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:284
msgid "У меня для тебя одна книжка..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "J’ai un livre pour toi..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:284
msgid "У меня снова для тебя книжка..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "J’ai à nouveau un livre pour toi..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:284
msgid "И снова у меня для тебя книжка..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Encore une fois, j’ai un livre pour toi..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:284
msgid "У меня для тебя подарок {i}(Пижама){/i}"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "J’ai un cadeau pour toi {i}(pyjama){/i}"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:284
msgid "У меня есть кое-что, о чём мы беседовали..."
msgid_plural "Ignore this. translate only: One"
msgstr[0] "J’ai la chose dont nous avons parlé..."
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:284
msgid "Прикупил для тебя немного сладенького!"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "J'ai acheté un chose sucrée pour toi!"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:284
msgid "У меня для тебя подарок {i}(Кожаный костюм){/i}"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "J’ai un cadeau pour toi{i}(Costume en cuir){/i}"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:284
msgid "У меня для тебя подарок {i}(Плётка){/i}"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "J’ai un cadeau pour toi{i}(Cravache){/i}"
msgstr[1] "Ignore this. translate only: One"

# XX## game/core/02init.rpy:284
msgid "Мам, я купил тебе одежду полегче!"
msgid_plural "Ignore this. translate only: One"
msgstr[0] "Maman, je t’ai acheté des vêtements plus légers!"
msgstr[1] "Ignore this. translate only: One"
