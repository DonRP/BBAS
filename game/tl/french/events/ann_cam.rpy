...
translate french cam0_ann_dressed_work_13752107:
...
translate french cam0_ann_dressed_shop_13752107:
...
translate french cam1_ann_sun_762850fc:

    # Max_09 "{m}Через эту камеру ничего не видно... Может посмотреть через другую?{/m}"
    Max_09 "{m}on ne voit rien À travers cette caméra... Peut-être regarder à travers l'autre?{/m}"

# game/events/ann_cam.rpy:257
translate french cam0_ann_swim_4bc4874c:
...
translate french cam0_ann_swim_14337802:
...
translate french cam1_ann_swim_e680e051:
...
translate french cam0_ann_alice_sun_767dabd9:
...
translate french cam1_ann_alice_sun_4bc4874c:

    # Max_09 "{m}Ничего толком не видно... Стоит взглянуть через другую камеру...{/m}"
    Max_09 "{m}Rien n'est vraiment visible... Je devrais regarder à travers une autre caméra...{/m}"

# game/events/ann_cam.rpy:292
translate french cam0_ann_alice_swim_4bc4874c:

    # Max_09 "{m}Ничего толком не видно... Стоит взглянуть через другую камеру...{/m}"
    Max_09 "{m}Rien n'est vraiment visible... Je devrais regarder à travers une autre caméra...{/m}"

# game/events/ann_cam.rpy:294
translate french cam0_ann_alice_swim_14337802:

    # Max_09 "{m}Ничего не разглядеть... Нужно установить камеру, которая охватила бы весь бассейн...{/m}"
    Max_09 "{m}rien à voir... Nous devons installer une caméra qui couvrirait toute la piscine...{/m}"

# game/events/ann_cam.rpy:317
translate french cam1_ann_alice_swim_94989c11:
...
translate french cam0_ann_bath_9a38aaa7:
